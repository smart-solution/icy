    ...
    <% setLang(o.partner_id.lang) %>
		<table class="shipping_address">
        	<tr>
        		...
        		<td width="65%">
          		...
          		<h3><b>${_('Purchase Order')} : ${ o.name }</b></h3>
                </td>
             </tr>
		</table>
        </br>
        ...
        <table class="tr_bottom_line" STYLE="font-size: 9px;">
            <tr>
                ...
                <td style="text-align:right" width="17%" VALIGN="top">
                  <b>${_('Quantity')}</b>
                </td>
        ...
        <table  class="tr_bottom_line_dark_grey"STYLE="font-size: 9px;">
          <tr>
            ...
            <td width="17%" align="right" VALIGN="top">
              ...
              <td width="13%" align="right" VALIGN="top">
                    ${ formatLang(order_line.price_unit, digits=get_digits(dp='Product Price') ) }
              </td>
              <td width="15%" align="right" VALIGN="top">
                    ${o.pricelist_id.currency_id.name} ${ formatLang(order_line.price_subtotal, digits=get_digits(dp='Account')) }
              </td>
          </tr>
        </table>
         %endfor
         <table width="95%" STYLE="font-size: 9px;">
            <tr>
                ...
                <td width="30%">
                    <table class="tr_top" STYLE="font-size: 9px;">
                        <tr>                
                            <td>
                                ${_('Net Total :')}
                            </td>
                            ...
                            <td align="right">
                                ${o.pricelist_id.currency_id.name} ${ formatLang(o.amount_untaxed, digits=get_digits(dp='Account')) }
                            </td>
                       </tr>
                       <tr>
                           <td>
                           ...
                           <td align="right">
                                ${o.pricelist_id.currency_id.name} ${ formatLang(o.amount_tax, dp='Account') }
                           </td>
                       </tr>
                    </table>
                    <table class="tr_top" STYLE="font-size: 9px;">
                        <tr>
                            ...
                            <td>
                            <td align="right">
                                 ${o.pricelist_id.currency_id.name} <b>${ formatLang(o.amount_total, digits=get_digits(dp='Account')) }</b>
                            </td>
                        </tr>
                    </table>
                </td>
